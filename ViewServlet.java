...
public class ViewServlet extends HttpServlet {  
    protected void doGet(HttpServletRequest request, HttpServletResponse response)   
        ...
        out.print("<tr><th>Id</th><th>Name</th><th>Password</th><th>Email</th><th>Profession</th>  
                 <th>Edit</th><th>Delete</th></tr>");  
        for(Emp e:list){  
         out.print("<tr><td>"+e.getId()+"</td><td>"+e.getName()+"</td><td>"+e.getPassword()+"</td>  
                 <td>"+e.getEmail()+"</td><td>"+e.getProfession()+"</td><td><a href='EditServlet?id="+e.getId()+"'>edit</a></td>  
